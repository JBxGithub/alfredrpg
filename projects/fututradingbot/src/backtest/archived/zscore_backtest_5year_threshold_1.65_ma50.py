"""
Z-Score 策略回測 - 5年，閾值 1.65
回測期間: 2021-01-01 至 2026-01-01
策略: Z-Score Mean Reversion + MA50趨勢過濾，閾值 upper=1.65, lower=-1.65
初始資金: $100,000
倉位: 50%
"""
...
def main():
    """主函數 - 5年回測"""
    print("="*70)
    print("Z-Score 策略回測 - 5年，閾值 1.65 + MA50趨勢過濾")
    print("="*70)
    ...
    config = {
        ...
        'rsi_overbought': 65.0,         # RSI超買65
        'rsi_oversold': 35.0,           # RSI超賣35
    ...
    print(f"策略名稱: {report['strategy_name']} + MA50趨勢過濾")
    ...
    output_file = f"{output_dir}/zscore_backtest_5year_threshold_1.65_ma50.json"
