"""
TQQQ 2021年度回測腳本 - 原始策略參數版本
執行TQQQ單邊多空策略的2021年度回測（2021-01-01 至 2021-12-31）
...
def run_backtest():
    ...
    print("="*70)
    print("TQQQ Long/Short Strategy - 2021年度回測 (原始策略參數)")
...
def save_results(result: BacktestResult, strategy: TQQQBacktestStrategy):
    """保存回測結果到 reports/backtest_2021_original.json"""
    ...
    # 保存JSON結果（指定路徑）
    json_file = f'{report_dir}/backtest_2021_original.json'
    result_dict = {
