...
class ZScoreBacktestStrategy:
    ...
    def check_entry_signal(self, df: pd.DataFrame, idx: int) -> tuple:
        ...
        做多條件: Z-Score < -1.65 + RSI < 35
        做空條件: Z-Score > 1.65 + RSI > 65
        ...
        for i in range(len(df)):
            ...
            if not self.position:
                ...
                if signal_type:
                    ...
                    position_value = base_equity * self.config['position_pct']
...
def main():
    """主函數"""
    print("="*70)
    print("Z-Score 策略回測 - 2025年，閾值 1.65")
    print("="*70)
    ...
    output_file = f"{output_dir}/zscore_backtest_2025_threshold_1.65.json"
